...
const ReceiptView = ({ receipt, onGoBack }) => {
    ...
    return (
        <div className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 min-h-screen flex flex-col items-center">
            {/* Main Receipt Container */}
            <div
                id="receipt-content"
                className="w-full max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden p-8 sm:p-12 mb-8"
            >
                {/* Header Section */}
                ...
                <div className="space-y-8 mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                        <div>
                            <h3 className="text-lg font-semibold text-gray-800 mb-2">Client Details</h3>
                        ...
                        <div className="md:text-right">
                            <h3 className="text-lg font-semibold text-gray-800 mb-2">Payment Info</h3>
                            <p className="text-gray-700">
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4 bg-white space-y-2">
                            <div className="flex justify-between">
                                ...
                                <span className="font-bold text-lg text-green-600">₹{receipt.amountPaid}</span>
                            </div>
                            <div className="flex justify-between border-t border-gray-200 pt-2">
                                <span className="font-medium text-gray-700">Payment Mode</span>
                                <span className="text-gray-600">{receipt.modeOfPayment}</span>
                            </div>
                            <div className="flex justify-between border-t border-gray-200 pt-2">
                                <span className="font-medium text-gray-700">Bank Account</span>
                                <span className="text-gray-600">{receipt.bankAccount}</span>
                            </div>
                            <div className="flex justify-between border-t border-gray-200 pt-2 font-bold">
                                <span className="text-gray-800">Amount Due</span>
                                <span className="text-red-500">₹{receipt.amountDue}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div div className="w-full max-w-4xl flex flex-col sm:flex-row justify-between gap-4 print:hidden" >
                <button
                    onClick={onGoBack}
                    className="flex items-center justify-center px-8 py-3 text-sm font-medium text-gray-700 bg-white rounded-md border border-gray-300 shadow-md hover:bg-blue-300 transition-colors"
                >
                    Cancel
                </button>
                <div className="flex flex-col sm:flex-row gap-4">
                    <button
                        ...
                        className="flex items-center justify-center px-8 py-3 text-sm font-medium text-white bg-blue-600 rounded-md shadow-md hover:bg-blue-700 transition-colors"
                    >
                        <span className="mr-2"><FiPrinter /></span> Download & Print
                    </button>
                    <button
                        className="flex items-center justify-center px-8 py-3 text-sm font-medium text-white bg-green-600 rounded-md shadow-md hover:bg-green-700 transition-colors"
                    >
